...
let yourArray = ['string', 9, true, null, undefined];
...
/*
  ...
  Modify the function, using pop() and shift(), to remove the first and last elements of the argument array, and assign 
...
/*
  ...
  Modify the function using indexOf() so that it returns true if the passed element exists on the array, and false if it 
  does not.
*/
...
/*
  ...
  Somewhere on the third level, include the string "deep", on the fourth level, include the string "deeper", and on the 
...
/*
  ...
  Finish writing the function so that it returns true if the object passed to it contains all four names, Alan, Jeff, 
...
/*
  ...
  Use a for...in statement inside this function to loop through the allUsers object and return the number of users whose 
  online property is set to true. An example of an object which could be passed to countOnline is shown below. 
